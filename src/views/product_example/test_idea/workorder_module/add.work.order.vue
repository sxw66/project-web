        ...
        <div class="left">
          <el-form ref="RefLeftForm" :model="formInfo" :rules="rulesInfo" label-position="top">
            ...
            <el-form-item label="描述">
              <Editor v-model="formInfo.orderMark"></Editor>
            </el-form-item>
          </el-form>
        </div>
        <div class="right">
          <el-form ref="RefRightForm" :rules="rulesInfo" :model="formInfo" label-position="top">
            ...
            <el-form-item label="类型" prop="orderType">
              <el-select v-model="formInfo.orderType" style="width: 100%">
                <el-option
            ...
            <el-form-item label="客户">
              <el-select placeholder="请选择" v-model="formInfo.customerId" style="width: 100%">
                <el-option
...
<script setup lang="ts">
  ...
  const rulesInfo = reactive({
    orderTitle: [{ required: true, message: '请输入', trrigger: ['change', 'blur'] }],
    productId: [{ required: true, message: '请选择', trrigger: ['change', 'blur'] }],
    orderType: [{ required: true, message: '请选择', trrigger: ['change', 'blur'] }],
  })
