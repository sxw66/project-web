<template>
  <el-popover :visible="popoverShow" trigger="click" width="650px" placement="bottom-start">
    ...
    <el-scrollbar height="400px" style="position: relative">
      <el-form :model="formInDataLIst" class="demo-form-screen">
        <el-form-item>
  ...
  <el-button text type="primary" @click="handleClickSet">
    <el-icon><Setting /></el-icon>
    <span style="margin-left: 5px">设置</span>
  </el-button>
  <boardHeaderSetting :dialogBoardVisible="dialogVisible" @closeBoardVisible="closeBoardVisible" />
  <span class="filtrate-text">{{ amount }}条看板</span>
</template>
...
<script setup lang="ts">
  ...
  const dialogVisible = ref(false) // 设置的弹框状态
