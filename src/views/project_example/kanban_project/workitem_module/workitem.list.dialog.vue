  ...
  >
    ...
    <el-row>
          ...
          <div class="client-tabs">
            <el-tabs v-model="activeName" @tab-click="handleClick">
              <el-tab-pane label="基本信息" name="first">
                <div class="text-secondary"> 工作项介绍 </div>
                <Editor v-model="itemDesc" @onBlur="handeEditorBlur"></Editor>
      ...
      <el-col :span="6" class="dialog-right">
        <el-form label-position="left" label-width="90px" :model="state" style="max-width: 460px">
          <el-collapse v-model="activeNames">
            <el-collapse-item title="属性" name="1">
              <el-form-item label="工作项编号">
                <el-input v-model="state.itemCode" />
              </el-form-item>
              <el-form-item label="工作项标题">
                <el-input v-model="state.itemName" />
              </el-form-item>
              <el-form-item label="工作项类型">
                <el-select v-model="state.itemType" style="width: 100%">
                  <el-option
              ...
              <el-form-item label="需求类型" prop="needType">
                <el-select v-model="state.needType" style="width: 100%">
                  <el-option
              ...
              <el-form-item label="需求来源" prop="needFrom">
                <el-select v-model="state.needFrom" style="width: 100%">
                  <el-option
...
<script setup lang="ts">
  ...
  import { delCustomerPages, updateWorkitemList } from '@/api/modules/project'
  import { selectPriorityList, workitemTypeList, fromTypeList, itemTypeList } from './static'
  // 异步加载富文本选择器
  ...
  const { circleUrl, customerName, itemDesc } = toRefs(state)
  ...
  watchEffect(() => {
    ...
    if (props.ListFormData) {
      ...
      state.itemDesc = props.ListFormData.itemDesc
      state.itemCode = props.ListFormData.itemCode
      state.itemName = props.ListFormData.itemName
      state.itemType = props.ListFormData.itemType
      state.needFrom = props.ListFormData.needFrom
